...
from bot.handlers import alerts, analyze, markets, onboarding, orders, portfolio, status, trade, wallets
...
def build_app() -> Application:
    ...
    app.add_handler(CommandHandler("alerts", alerts.alerts_command))
