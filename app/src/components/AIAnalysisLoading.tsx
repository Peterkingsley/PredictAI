    ...
    <View style={styles.root}>
      <View style={styles.orbit}>
        <View style={styles.core}>
          <Ionicons color={colors.accent} name="sparkles" size={27} />
        </View>
      </View>
      <Text allowFontScaling={false} style={styles.title}>
        PredictAI is analysing this market
      </Text>
      <Text allowFontScaling={false} style={styles.subtitle}>
        Comparing market probability with multiple intelligence signals.
      </Text>
      <View style={styles.steps}>
          ...
          return (
            <View key={step} style={styles.step}>
              {complete ? (
                ...
                <Ionicons color={colors.textFaint} name="ellipse-outline" size={18} />
              )}
              <Text
                allowFontScaling={false}
                style={[styles.stepText, (complete || active) && styles.stepTextActive]}
              >
                {step}
              </Text>
            </View>
        ...
        <View style={styles.step}>
          ...
          <Text
            ...
            style={[
              styles.stepText,
              completedSteps >= analysisSteps.length && styles.stepTextActive,
            ]}
          >
            Generating verdict...
          </Text>
      ...
      <Text allowFontScaling={false} style={styles.disclaimer}>
        AI estimates can be wrong. Review the evidence before predicting.
      </Text>
    </View>
  );
}
