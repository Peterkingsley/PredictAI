...
export function WithdrawalScreen({ dailyLimit, defaultNetwork, enabledAssets, feeSpeed, initialAddress, initialNetwork, onBack, onComplete, requireBiometrics, requireConfirmation }: { dailyLimit: number; defaultNetwork: Network; enabledAssets: readonly Asset[]; feeSpeed: FeeSpeed; initialAddress?: string; initialNetwork?: Network; onBack: () => void; onComplete: () => void; requireBiometrics: boolean; requireConfirmation: boolean }) {
