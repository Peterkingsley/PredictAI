...
export const appNotifications: AppNotification[] = [
  {
    ...
    message: "Your prediction was placed successfully. You can track it from your activity.",
    time: "2 min ago",
    group: "Today",
  ...
  {
    id: "bitcoin-move",
    title: "Bitcoin event update",
    message: "The market “What price will Bitcoin hit in 2026?” has moved since your last visit.",
    time: "18 min ago",
    group: "Today",
  ...
  },
  {
    ...
    message: "Your wallet deposit has been confirmed and is now available.",
    time: "1 hr ago",
    group: "Today",
    icon: "wallet-outline",
    color: "#FFB14A",
  ...
  },
  {
    ...
    message: "A sign-in was detected from your current Android device in Lagos, Nigeria.",
    time: "4 hrs ago",
    group: "Today",
  ...
  },
  {
    ...
    message: "A sports event you followed has been resolved. Open your activity to see the result.",
    time: "Yesterday",
    group: "Earlier",
    icon: "trophy-outline",
    color: "#FF7B3B",
  ...
  {
    id: "welcome",
    title: "Welcome to PredictAI",
    message: "Discover events, make responsible predictions, and follow results in real time.",
    time: "3 days ago",
    group: "Earlier",
...
export function NotificationsScreen({
  ...
  const visible =
    filter === "Unread"
      ? appNotifications.filter((notification) => !isRead(notification))
      : appNotifications;
  const groups = (["Today", "Earlier"] as const)
    .map((group) => ({
      group,
      items: visible.filter((notification) => notification.group === group),
    }))
  ...
  return (
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        <Pressable disabled={unreadCount === 0} hitSlop={8} onPress={onMarkAllRead}>
          <Text
      ...
      <View style={styles.summary}>
        ...
        <View style={styles.summaryIcon}>
          <Ionicons color={colors.accent} name="notifications-outline" size={23} />
        </View>
      </View>
            ...
            <View style={styles.list}>
              {items.map((notification) => {
                ...
                return (
                  ...
                  >
                    <View style={[styles.itemIcon, { backgroundColor: `${notification.color}1F` }]}>
                      <Ionicons color={notification.color} name={notification.icon} size={21} />
                    </View>
                    <View style={styles.itemCopy}>
                      <View style={styles.itemTitleRow}>
                        <Text
                          allowFontScaling={false}
                          numberOfLines={1}
                          style={[styles.itemTitle, read && styles.itemTitleRead]}
                        >
                          {notification.title}
                        </Text>
                      ...
                      <Text allowFontScaling={false} style={styles.itemMessage}>
        ...
        {visible.length === 0 ? (
          <View style={styles.empty}>
            <View style={styles.emptyIcon}>
              <Ionicons color={colors.textMuted} name="checkmark-done-outline" size={32} />
            </View>
            <Text allowFontScaling={false} style={styles.emptyTitle}>
              You’re all caught up
            </Text>
            <Text allowFontScaling={false} style={styles.emptyText}>
              New updates about your predictions, wallet, and account will appear here.
            </Text>
            <Pressable onPress={() => setFilter("All")} style={styles.showAll}>
...
const styles = StyleSheet.create({
  ...
  itemUnread: { backgroundColor: "#181A1D" },
  itemIcon: {
    width: 40,
    height: 40,
    borderRadius: 12,
