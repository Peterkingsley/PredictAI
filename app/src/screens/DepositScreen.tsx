      ...
      <View style={styles.content}>
        ...
        <View style={styles.depositCard}>
          <View style={styles.qrPlaceholder}>
            <Ionicons color={colors.text} name="qr-code-outline" size={94} />
          </View>
          <Text allowFontScaling={false} style={styles.depositTitle}>
            {asset} deposit address
          </Text>
          <Text allowFontScaling={false} style={styles.network}>
            Network: {chain}
          </Text>
        ...
        <View style={styles.warning}>
          <Ionicons color="#F0A23A" name="warning-outline" size={20} />
          <Text allowFontScaling={false} style={styles.warningText}>
            Only send {asset} using the {chain} network. Sending another asset or using another
...
const styles = StyleSheet.create({
  ...
  depositCard: { borderRadius: 16, backgroundColor: "#181A1D", padding: 18, alignItems: "center" },
  qrPlaceholder: {
    width: 126,
    height: 126,
    borderRadius: 12,
  ...
  network: { color: colors.textMuted, fontSize: 12, marginTop: 5 },
  addressRow: {
    width: "100%",
    minHeight: 54,
    borderRadius: 10,
  ...
  address: { flex: 1, color: colors.text, fontSize: 11, lineHeight: 16 },
  copyButton: {
    marginTop: 12,
  ...
  copyText: { color: colors.accent, fontSize: 12, fontWeight: "600" },
  warning: {
    flexDirection: "row",
  ...
  warningText: { flex: 1, color: "#D9A15D", fontSize: 11, lineHeight: 17 },
  doneButton: {
    marginTop: "auto",
    minHeight: 46,
    borderRadius: 12,
  ...
  doneText: { color: colors.buttonText, fontSize: 15, fontWeight: "600" },
});
