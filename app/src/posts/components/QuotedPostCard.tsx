...
const styles = StyleSheet.create({ card: { marginTop: 10, borderRadius: 10, borderWidth: 1, borderColor: colors.border, padding: 10 }, pressed: { opacity: .7 }, author: { color: colors.text, fontSize: 10, fontWeight: '600' }, username: { color: colors.textMuted, fontWeight: '400' }, content: { color: colors.textMuted, fontSize: 10, lineHeight: 15, marginTop: 5 }, attachment: { color: colors.textFaint, fontSize: 8, marginTop: 7 } });
